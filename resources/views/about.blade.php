...
@section('content')
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-14 items-center">
                <div>
                    ...
                    <h2 class="text-3xl sm:text-4xl font-extrabold mt-2 mb-6" style="color:#1E3A5F;">More Than a Coaching Centre</h2>
                ...
                <div class="grid grid-cols-2 gap-5">
                    ...
                    <div class="rounded-2xl p-6 text-center border border-gray-100 shadow-sm hover:shadow-md transition-shadow">
                        ...
                        <p class="text-3xl font-extrabold mb-1" style="color:#1E3A5F;">{{ $n }}</p>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid md:grid-cols-2 gap-8">
                <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                    ...
                    <h3 class="text-xl font-bold mb-3" style="color:#1E3A5F;">Our Mission</h3>
                    <p class="text-gray-600 leading-relaxed">
                ...
                <div class="bg-white rounded-2xl p-8 border border-gray-100 shadow-sm">
                    <div class="h-12 w-12 rounded-xl flex items-center justify-center text-2xl mb-5" style="background:#FFF7ED;">🌟</div>
                    <h3 class="text-xl font-bold mb-3" style="color:#1E3A5F;">Our Vision</h3>
                    <p class="text-gray-600 leading-relaxed">
    ...
    <section class="py-20 bg-white">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14">
                ...
                <h2 class="text-3xl sm:text-4xl font-extrabold mt-2" style="color:#1E3A5F;">What Makes NVAAK Different</h2>
            </div>
    ...
    <section class="py-16 bg-orange-50 border-y border-orange-100">
        <div class="max-w-3xl mx-auto px-4 text-center">
            <h2 class="text-3xl font-extrabold mb-3" style="color:#1E3A5F;">Ready to Begin Your Journey?</h2>
